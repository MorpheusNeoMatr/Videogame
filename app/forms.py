...
class Add_Game(FlaskForm):
    ...
    game_picture_3 = FileField('game_picture_3', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    game_picture_4 = FileField('game_picture_4', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    game_picture_5 = FileField('game_picture_5', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    game_picture_6 = FileField('game_picture_6', validators=[FileAllowed(['jpg'], 'JPG Only!')])
...
class Add_Company(FlaskForm):
    ...
    company_picture_1 = FileField('company_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    company_picture_2 = FileField('company_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!')])
...
class Add_Directors(FlaskForm):
    ...
    director_picture_1 = FileField('director_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    director_picture_2 = FileField('director_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!')])
...
class Add_Founders(FlaskForm):
    ...
    founder_picture_1 = FileField('founder_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!')])
    founder_picture_2 = FileField('founder_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!')])
