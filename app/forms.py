...
class Register(FlaskForm):
    ...
    user_picture = FileField('picture', validators=[DataRequired(), FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
...
class Add_Game(FlaskForm):
    ...
    game_picture_1 = FileField('game_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    game_picture_2 = FileField('game_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    game_picture_3 = FileField('game_picture_3', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    game_picture_4 = FileField('game_picture_4', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    game_picture_5 = FileField('game_picture_5', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    game_picture_6 = FileField('game_picture_6', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.game_series.choices = [(0, 'Choose series')] + [(series.id, series.name) for series in Series.query.all()]
...
class Add_Company(FlaskForm):
    ...
    company_picture_1 = FileField('company_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    company_picture_2 = FileField('company_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
...
class Add_Directors(FlaskForm):
    ...
    director_picture_1 = FileField('director_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    director_picture_2 = FileField('director_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
...
class Add_Founders(FlaskForm):
    ...
    founder_picture_1 = FileField('founder_picture_1', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
    founder_picture_2 = FileField('founder_picture_2', validators=[FileAllowed(['jpg'], 'JPG Only!'), file_size_limit])
